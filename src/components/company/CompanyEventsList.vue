  ...
  <div class="flex-grow mb-16 flex flex-col">
    ...
    >
      <div class="flex flex-row gap-2">
        ...
        <div class="dropdown dropdown-end">
          ...
          >
            <li>
              <a @click="createCalendarEvent(event)">Add to Google Calendar</a>
            </li>
            <li>
    ...
    <div class="m-auto flex flex-col" v-if="events.length === 0">
      ...
      <p class="text-gray-300 m-auto w-64 text-center">
        You have no upcoming events, wait for an enterprise to approve your
        application if you've applied.
      </p>
    </div>
  </div>
</template>
