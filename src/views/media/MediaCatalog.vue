  ...
  <div class="card w-96 bg-base-100 shadow-xl">
    <div class="card-body">
      ...
      <p class="text-base-300">
        ...
        trash!! #LoveSG #SavetheWorld #LeafySG
      </p>
      <div class="card-actions justify-end">
        <div class="badge badge-outline">Climate Action</div>
        <div class="badge badge-outline">Beach Clean-Up</div>
      </div>
    </div>
    <figure>
      <img
        class="p-1"
        src="https://static.mothership.sg/1/2019/09/Gai-Gai-1.jpg"
        alt="Beach-clean-up-1"
      />
    </figure>
  </div>
</template>
